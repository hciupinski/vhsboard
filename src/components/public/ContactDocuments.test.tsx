...
describe("ContactDocuments", () => {
  it("renders stored PDF links in a new tab", async () => {
    mockedList.mockResolvedValue([{ id: "123e4567-e89b-12d3-a456-426614174000", title: "Regulamin", path: "documents/123e4567-e89b-12d3-a456-426614174000.pdf", position: 0, signedUrl: "https://signed.example/regulamin.pdf" }]);
    render(<QueryClientProvider client={new QueryClient({ defaultOptions: { queries: { retry: false } } })}><ContactDocuments /></QueryClientProvider>);
