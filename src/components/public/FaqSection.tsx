  ...
  return (
    <section className="border-t border-border bg-background" aria-labelledby={headingId}>
      <div className="mx-auto max-w-6xl px-5 py-16 sm:py-20">
        <p className="text-xs font-semibold uppercase tracking-[0.2em] text-primary">Dobrze wiedzieć</p>
        <h2 id={headingId} className="mt-3 text-4xl leading-[0.95] uppercase sm:text-5xl">
          Najczęściej zadawane pytania
        </h2>
        <p className="mt-5 max-w-2xl text-lg leading-relaxed text-muted-foreground">
          Zebraliśmy najważniejsze informacje, żeby łatwiej było wybrać właściwy termin i ruszyć
          w drogę.
        </p>
